...
public class Start {
    ...
    public Start() {
        ...
        hdv2 = new Label("Mario" + "\n" + 
                "Hola tengo .. años soy estudiante de la Universidad Nacional de Colombia, En mi tiempo libre me gusta ...\"");
        hdv2.setMaxWidth(200);
        hdv2.setWrapText(true);
        hdv2.setFont(new Font("Arial",20));
        hdv2.setStyle("-fx-text-alignment: justify;");
        hdv2.setStyle("-fx-padding: 0 0 10 0;");                
        ...
        marco2.setFitHeight(altoGrid / 2);
        marco2.setFitWidth(anchoGrid / 2);
        marco3.setFitHeight(altoGrid / 2);
        marco3.setFitWidth(anchoGrid / 2);
        marco4.setFitHeight(altoGrid / 2);
        marco4.setFitWidth(anchoGrid / 2);
